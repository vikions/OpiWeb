...
_SERVER_SIGNING_PK_RAW = os.getenv("WEB_EXPERIMENT_SERVER_PRIVATE_KEY", "").strip()
if _SERVER_SIGNING_PK_RAW and not _SERVER_SIGNING_PK_RAW.startswith("0x"):
    _SERVER_SIGNING_PK_RAW = f"0x{_SERVER_SIGNING_PK_RAW}"
SERVER_SIGNING_PRIVATE_KEY = _SERVER_SIGNING_PK_RAW or None
